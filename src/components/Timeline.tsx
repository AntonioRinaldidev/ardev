						...
						>
							<div className="dropdown-header">
								<div className="dropdown-title-section">
									<h3 className="dropdown-title">{item.experienceDetails.title}</h3>
									<p className="dropdown-company">{item.experienceDetails.company}</p>
								</div>
								...
								{item.experienceDetails.technologies.length > 0 && (
									<div className="dropdown-section">
										...
										<div className="tech-tags">
											{item.experienceDetails.technologies.map((tech: string | number | bigint | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<React.AwaitedReactNode> | null | undefined, index: React.Key | null | undefined) => (
												<span
													key={index}
													className="tech-tag">
													{tech}
								...
								{item.experienceDetails.achievements.length > 0 && (
									<div className="dropdown-section">
										...
										<ul className="achievements-list">
											{item.experienceDetails.achievements.map((achievement: string | number | bigint | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<React.AwaitedReactNode> | null | undefined, index: React.Key | null | undefined) => (
												<li
													key={index}
							...
							{/* Links progetti */}
							{item.experienceDetails.projectLinks && item.experienceDetails.projectLinks.length > 0 && (
								<div className="dropdown-footer">
									<div className="project-links">
										{item.experienceDetails.projectLinks.map((link: ProjectLink, index: React.Key | null | undefined) => {
