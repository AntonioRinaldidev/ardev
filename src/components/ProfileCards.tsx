...
const ProfileCard: React.FC<ProfileCardProps> = ({ fullName }) => {
  // Alzato il breakpoint a 992px per gestire meglio i tablet
  ...
  return (
    <>
      <Card>
        {/* WRAPPER DI LAYOUT: Gestisce la struttura a 1 o 2 colonne */}
            ...
            >
              ...
              <div className="profile-info-redesign">
                ...
                <div className="profile-role-redesign">
                  ...
                  <span className="role-dynamic">Full-Stack</span>
              ...
              >
                ...
                <div className="actions-footer">
                  <div className="footer-message">
                    ...
                    <span>Crafted with italian pizza </span>
                  </div>
                </div>
              </motion.div>
            </div>
